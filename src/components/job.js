	...
	render() {
		return (
			<tr>
				...
				<td>{this.props.offer.salary} <FormattedPlural value={this.props.offer.salary} one={<FormattedMessage id="million"/>} other={<FormattedMessage id="millions"/>}></FormattedPlural></td>
				...
				<td><FormattedDate
					...
					weekday='long'
				/></td>
				<td><FormattedNumber value={this.props.offer.visits}></FormattedNumber></td>
			</tr>
		);
	}
}